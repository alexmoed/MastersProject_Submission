...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                type="RandomDropout", dropout_ratio=0.0, dropout_application_ratio=1.0
            ),
            ...
            dict(type="SphereCrop", point_max=58768, mode="random"),  # Using SONATA's larger point count
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(type="SphereCrop", point_max=58768, mode='center'),  # Keep original for val
            dict(type="CenterShift", apply_z=False),
            dict(type="NormalizeColor"),
            dict(
                type="InstanceParser",
    ...
    test=dict(
        ...
        transform=[
            ...
            dict(type="SphereCrop", point_max=58768, mode='center'),
            dict(type="CenterShift", apply_z=False),
            dict(type="NormalizeColor"),
            dict(
                type="InstanceParser",
